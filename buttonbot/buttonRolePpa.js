...
function buttonRolePpa() {
    client.on('ready', async () => {
        const channel = client.channels.cache.get('914590722248806400'); //914590722248806400 << Ana Tomie CMAP-PPA     //1042396330108141600 mon salon
        channel.send({
...
function handleButtonRolePpa() {
    const ROLES = {
        PPA: '991454913605419069', //991454913605419069 << En attente d'éval psy  //mon test 1043131912790749204
        CMAP: '991455109764612126' //991455109764612126 << En attente de certif médical //mon test cmap 1043138176291704962
    };
