...
module.exports = {
	...
	.setName('permanencetyler')
	.setDescription('Envoi une permanence pour le Dr. Tyler Rake')
		...
		.addStringOption(option =>
            option.setName('endroit')
				...
				async execute(interaction) {
					...
					const hospitalTyler = interaction.options.getString('hopital')
					const endroitTyler = interaction.options.getString('endroit')
					...
					content : `
Hey !
Le docteur <@225349654974431232> est actuellement **disponible** à l'hôpital de **${hospitalTyler}** dans le **${endroitTyler}**!
                
**N'hésitez pas à prendre contact avec lui pour toute demande, récupérer votre prime ou réclamation !**
https://cdn.discordapp.com/attachments/1004187230023204974/1164251752883834961/gif_direction_1.gif
<@&774370184328642590>`})
	}
	catch (error) {
