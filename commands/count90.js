...
module.exports = {
  ...
  async execute(interaction) {
    try {
      ...
      // Récupérer tous les messages embeds du salon spécifié
      let allMessages = [];
      ...
      do {
        ...
        const messages = await channelToSend.messages.fetch(options);
        if (messages.size > 0) {
      ...
      // Filtrer les messages avec des embeds
      ...
      sortedMembers.forEach((member) => {
        ...
        } else if (userId === '310889892802461696') {
          displayName = 'Dr. Aiyana Durazzo';
        } else if (userId === '455801536413564940') {
          displayName = 'Dr. Kayla Smith';
        } else if (userId === '451378090711449621') {
          displayName = 'Dr. Kiyane Vintorez';
